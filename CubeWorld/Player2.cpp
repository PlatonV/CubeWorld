...
CW::Player2::Player2(float x, float y, Terrain* terrain)
{
	Position.x = x;
	Position.y = y;
...
void CW::Player2::MoveRight(void) 
{
	if (mOnGround)
	{
...
void CW::Player2::Update(float dt)
{
...
void CW::Player2::Draw(Renderer* renderer)
{
	glDisable(GL_BLEND);
